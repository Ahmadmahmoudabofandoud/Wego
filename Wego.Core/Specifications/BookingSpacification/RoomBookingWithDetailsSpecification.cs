...
namespace Wego.Core.Specifications.BookingSpacification
{
    ...
    public class RoomBookingHotelWithDetailsSpecification : BaseSpecifcation<RoomBooking>
    {
        public RoomBookingHotelWithDetailsSpecification(RoomBookingSpecParams specParams)
                : base(RB =>
                    (string.IsNullOrEmpty(specParams.Search) ||
                     (RB.Room.RoomTitle != null && RB.Room.RoomTitle.ToLower().Contains(specParams.Search)) ||
                     (RB.Booking.UserId != null && RB.Booking.UserId.ToLower().Contains(specParams.Search))) &&
        ...
        public RoomBookingHotelWithDetailsSpecification(int bookingid)
            : base(RB => RB.BookingId == bookingid)
        {
