    ...
    public partial class initialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    RoomDescribtion = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomBookingDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RoomBookingDetails_Bookings_BookingId",
                        column: x => x.BookingId,
                        principalTable: "Bookings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoomBookingDetails_Rooms_RoomId",
                        column: x => x.RoomId,
                        principalTable: "Rooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Flights_Terminals_ArrivalTerminalId",
                        column: x => x.ArrivalTerminalId,
                        principalTable: "Terminals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Flights_Terminals_DepartureTerminalId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Flights_ArrivalTerminalId",
                table: "Flights",
                column: "ArrivalTerminalId");

            migrationBuilder.CreateIndex(
                name: "IX_Flights_DepartureTerminalId",
                table: "Flights",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomBookingDetails_BookingId",
